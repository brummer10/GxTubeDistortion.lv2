...
void Gx_TubeDistortion_::init_dsp_(uint32_t rate)
{
  ...
  TubeDistortion_in->set_samplerate(rate, TubeDistortion_in); // init the DSP class
  TubeDistortion_clip->set_samplerate(rate, TubeDistortion_clip); // init the DSP class
  TubeDistortion_out->set_samplerate(rate, TubeDistortion_out); // init the DSP class
}
...
void Gx_TubeDistortion_::run_dsp_(uint32_t n_samples)
{
  ...
  if (needs_ramp_down) {
    for (uint32_t i=0; i<n_samples; i++) {
      ...
      output[i] *=  (ramp_down /ramp_down_step) ;
    }
  ...
  if (!bypassed) {
      TubeDistortion_in->mono_audio(static_cast<int>(n_samples), output, output, TubeDistortion_in);
      TubeDistortion_clip->mono_audio(static_cast<int>(n_samples), output, output, TubeDistortion_clip);
      TubeDistortion_out->mono_audio(static_cast<int>(n_samples), output, output, TubeDistortion_out);
  }
}
