...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_TubeDistortionUI* ui = (gx_TubeDistortionUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxTubeDistortion" ;
    ...
    set_expose_func(GX_TUBEDISTORTION_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    gtk_box_pack_start(GTK_BOX(ui->box), ui->vbox, TRUE, TRUE, 85);
    gtk_box_pack_end(GTK_BOX(ui->pbox), ui->vbox1, TRUE, TRUE, 15);
    ...
    ui->label[0] = gtk_label_new("INPUT");
    ...
    ui->args[0]->ui = ui;
    ui->args[0]->port_index = (int)INPUT;
